...
async def generate_prior_auth(
    ...
    **CMS-0057-F COMPLIANCE:**
    ...
    try:
        timeline = await query_patient_timeline(ctx, patient_id, "DiagnosticReport", limit=5)
    except Exception as e:
        ...
        "entry": [
            {"fullUrl": f"Patient/{patient_id}", "resource": patient_data},
            {
                ...
                "resource": {
                    ...
                    "priority": {
                        "coding": [{"code": "urgent" if "🚨" in str(comparison) else "normal"}]
                    },
                    "diagnosis": [
                        {
                            "sequence": 1,
                    ...
                    "item": [
                        {
                            ...
                            "extension": [
                                ...
                                },
                                {
                                    ...
                                    "valueString": medical_necessity["longitudinal_summary"],
                                },
                            ],
                        }
                    ],
                    "supportingInfo": [
                        {
                            "sequence": 1,
                            "category": {"coding": [{"code": "info", "display": "Information"}]},
    ...
    result = {
        ...
        "approval_likelihood": _estimate_approval_likelihood(comparison, medical_necessity),
        "meta": {
            "compliance": "CMS-0057-F (2026)",
...
def _estimate_approval_likelihood(comparison: Optional[Dict], medical_necessity: Dict) -> Dict:

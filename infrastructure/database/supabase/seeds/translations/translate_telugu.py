"""
Telugu Translation Script for Netra AI
Translates English locale files to Telugu using LibreTranslate
"""
...
def translate_str(text):
    """Translate a single string to Telugu"""
...
if __name__ == '__main__':
    ...
    file_path = "frontend/src/locales/te.json"

"""
Kannada Translation Script for Netra AI
Translates English locale files to Kannada using LibreTranslate
"""
...
def translate_str(text):
    """Translate a single string to Kannada"""
...
if __name__ == '__main__':
    ...
    file_path = "frontend/src/locales/hi.json"
